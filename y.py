...
if __name__ == "__main__":
    ...
    port = 12347  # The port to listen on

    input_dir = "Y_INPUT"  # The directory to extract the zip contents to
    output_dir = "Y_OUTPUT"  # The directory to save processed files to
