...
if __name__ == "__main__":
    ...
    port = 12348  # The port to listen on

    input_dir = "Z_INPUT"  # The directory to extract the zip contents to
    output_dir = "Z_OUTPUT"  # The directory to save processed files to
